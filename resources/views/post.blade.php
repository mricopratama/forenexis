                ...
                <header class="mb-4 lg:mb-6 not-format">
                    ...
                    <address class="flex items-center my-6 not-italic">
                        <div class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                            ...
                            <div>
                                <a href="/authors/{{ $post->author->slug }}" rel="author" class="text-xl font-bold text-gray-900 dark:text-white">{{ $post->author->name }}</a>
                                <p class="text-base text-gray-500 dark:text-gray-400">{{ $date->diffInDays() > 7 ? $date->format('d M Y') : $date->diffForHumans() }}</p>
